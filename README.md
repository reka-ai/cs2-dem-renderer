...
Counter-Strike 2 updates break compatibility with the server plugin with this branch built for version 1.41.6.5. See the branches for other game versions.
